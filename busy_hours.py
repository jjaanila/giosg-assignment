...
def pretty_print(busiest_days, presence_counts):
...
def main():
    ...
    busiest_days = get_busiest_days(args.start_date, args.end_date, 3, args.token)
    presence_counts = get_user_presence_counts(args.start_date, args.end_date, args.token)
    pretty_print(busiest_days, presence_counts)
